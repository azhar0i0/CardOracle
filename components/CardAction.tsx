            ...
            >
              ...
              <View style={styles.header}>
                <View>
                  ...
                  <Text style={styles.cardIdLabel}>Card #{card.id}</Text>
                </View>
              ...
              <View style={styles.previewContainer}>
                ...
                >
                    ...
                    <Text style={styles.previewTitle} numberOfLines={1}>{card.title}</Text>
                    <Text style={styles.previewMessage} numberOfLines={2}>{card.message}</Text>
                </LinearGradient>
              </View>
          ...
          <Pressable style={styles.alertContainer} onPress={(e) => e.stopPropagation()}>
            ...
            >
              ...
              <Text style={styles.alertMessage}>
                This will permanently remove <Text style={styles.boldText}>"{card.title}"</Text> from your deck.
              </Text>
